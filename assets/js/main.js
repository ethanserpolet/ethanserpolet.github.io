...
function validateName(){
    ...
    if(name.length == 0){
        nameError.innerHTML = 'Merci de mettre un nom complet !';
        return false;
    }
...
function validateEmail(){
    ...
    if(email.length == 0){
        emailError.innerHTML = 'Une adresse e-mail valide est demandé !';
        return false;
    }
...
function validateMessage(){
    ...
    if (left>0){
        messageError.innerHTML = left + ' de plus sont demandés !';
        return false;
    }
...
function SendMail(){
    ...
    if(!validateName() || !validateEmail() || !validateMessage() ){
        ...
        swal("Désolé !", "Veuillez corriger les erreurs..", "warning");
        return false;
    }
    ...
    emailjs.send("service_8io7gbe", "template_5x6b7bf", params).then(function (res){
        // alert("Success! " + res.status);
        // alert("Your message has been sent successfully!");
        swal("Youpi !", "Votre message a bien été envoyé.", "success");
    })
}